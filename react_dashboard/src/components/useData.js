...
export const FetchData = () => {
    ...
    useEffect(()=>{
        const urlSpots = "http://localhost:8000/trackid/";
...
export const FetchGeom = () =>{
    ...
    useEffect(()=>{
        // const urlZones = "https://makerghat.urbansciences.in/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typename=geonode%3Aswk_13_zone_polygons&outputFormat=json&srs=EPSG%3A4326&srsName=EPSG%3A4326";
